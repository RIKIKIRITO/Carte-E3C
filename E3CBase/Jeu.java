...
public class Jeu {
    ...
    public void piocherEtPlacerNouvellesCartes(int[] numerosDeCartes) {
        ...
        for (int j = 0 ; j<numerosDeCartes.length; j++){
            Ut.afficher(numerosDeCartes[j]);
        }
        if (paquet.peutPiocher(numerosDeCartes.length)){
    ...
    public void jouerTourHumain() {
        ...
        Carte[] cartes = new Carte[cartesE3C.length];
        cartes = table.getCarteslectionner(cartesE3C);
